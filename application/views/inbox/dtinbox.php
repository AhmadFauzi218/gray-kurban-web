          ...
          <div class="card mb-4 py-3 border-left-primary">
            <div class="card-body">
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Informasi Inbox</h1>
              </div>
            </div>
          </div>
                    ...
                    <div class="table table-responsive">
                      ...
                      <?php $no =1; 
                        ...
                        <tbody>
                          <tr>
                            <td><?php echo $no++; ?></td>
                            <td class="text-center"><?php echo $data->fullname?></td>
                            <td class="text-center"><?php echo $data->email?></td>
                            <td class="text-center"><?php echo $data->deskripsi?></td>
                            <td class="text-center"><?php echo $data->pesan?></td>
                            
                            <td>  <a href="<?=base_url()?>index.php/Inbox/edit/<?=$data->id_inbox?>" class="btn btn-success btn-sm">
                                <i class=""></i> Edit
                              </a> |
                              <a href="<?=base_url()?>index.php/Inbox/deletedata/<?=$data->id_inbox?>" class="btn btn-danger btn-sm">
                                <i class=""></i> Hapus
                              </a>
                            </td>
                          </tr>
